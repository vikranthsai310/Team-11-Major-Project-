...
### Report draft — P6-11 … P6-16 in progress
...
| P6-15 — Chapter 8 | ◐ §8.1–8.4, A1/A2/A5 and §8.12 final; §8.5–8.9 show validation results with yellow placeholders for the test-split table, F5, F6, F8 and the S2–S6 verdicts |
| P6-16 — Chapter 9 | ◐ drafted; G1 and the concluding headline wait on the test split |
